...
export default function Editor({
  ...
  value: GenerateInput;
  onChange: (v: GenerateInput) => void;
}) {
  const v = value;
  const [featureDraft, setFeatureDraft] = useState("");
  const [techDraft, setTechDraft] = useState("");
  const [ideasDraft, setIdeasDraft] = useState("");
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Input
          ...
          onChange={(e) =>
            onChange({
              ...v,
              profile: { ...v.profile, devName: e.target.value },
            })
          }
        />
        <Input
          ...
          onChange={(e) =>
            onChange({
              ...v,
              profile: { ...v.profile, location: e.target.value },
            })
          }
        />
        <Input
          ...
          onChange={(e) =>
            onChange({
              ...v,
              profile: { ...v.profile, repoURL: e.target.value },
            })
          }
        />
        <Input
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Input
          ...
          onChange={(e) =>
            onChange({
              ...v,
              project: { ...v.project, tagline: e.target.value },
            })
          }
        />
      </div>
      <Textarea
        ...
        onChange={(e) =>
          onChange({
            ...v,
            project: { ...v.project, description: e.target.value },
          })
        }
      />
      ...
      <div className="grid gap-4">
            ...
            <button
              ...
              onClick={() => {
                ...
                onChange({
                  ...
                  project: {
                    ...v.project,
                    features: [...v.project.features, featureDraft.trim()],
                  },
                });
                setFeatureDraft("");
              }}
                  ...
                  <button
                    ...
                    onClick={() =>
                      onChange({
                        ...
                        project: {
                          ...v.project,
                          features: v.project.features.filter(
                            (_, idx) => idx !== i
                          ),
                        },
                      })
        ...
        <div>
          ...
          <div className="flex gap-2 mt-1">
            <input
              ...
              placeholder="Add a technology and press +"
            />
            <button
              type="button"
              className="rounded-xl px-3 border border-white/10"
              onClick={() => {
                ...
                onChange({
                  ...
                  project: {
                    ...v.project,
                    tech: [...v.project.tech, techDraft.trim()],
                  },
                });
                setTechDraft("");
              }}
                  ...
                  <button
                    ...
                    onClick={() =>
                      onChange({
                        ...
                        project: {
                          ...v.project,
                          tech: v.project.tech.filter((_, idx) => idx !== i),
                        },
                      })
                    }
                  >
        ...
        <div>
          <label className="text-sm text-neutral-300">Ideas Learned</label>
          <div className="flex gap-2 mt-1">
            <input
              className="flex-1 rounded-xl bg-white/5 border border-white/10 px-3 py-2 outline-none"
              value={ideasDraft}
              onChange={(e) => setIdeasDraft(e.target.value)}
              placeholder="Add an idea and press +"
            />
            <button
              type="button"
              className="rounded-xl px-3 border border-white/10"
              onClick={() => {
                if (!ideasDraft.trim()) return;
                onChange({
                  ...v,
                  project: {
                    ...v.project,
                    ideas: [...v.project.ideas, ideasDraft.trim()],
                  },
                });
                setIdeasDraft("");
              }}
          ...
          {v.project.ideas.length > 0 && (
            <ul className="mt-2 text-sm list-disc list-inside space-y-1">
              {v.project.ideas.map((it, i) => (
                <li key={i}>
                  {it}
                  <button
                    className="ml-2 text-xs text-neutral-400 hover:underline"
                    onClick={() =>
                      onChange({
                        ...
                        project: {
                          ...v.project,
                          ideas: v.project.ideas.filter((_, idx) => idx !== i),
                        },
                      })
                    }
                  >
